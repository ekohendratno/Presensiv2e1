...
public class HalamanPelajaranDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guru_pelajarandetail);
        ...
        context = HalamanPelajaranDetail.this;
    ...
    private void getPresensiSiswaByPelajaran(){

        try {
            ArrayList<Presensi> items = new ArrayList<>();

            JSONObject j1 = koneksi.getDataServer("/api/presensi_byguru?key="+key);
