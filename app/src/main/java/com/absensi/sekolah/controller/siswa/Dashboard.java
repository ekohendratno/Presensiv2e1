...
public class Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.m1).setOnClickListener(v -> {
            Intent intent = new Intent(context, com.absensi.sekolah.controller.siswa.HalamanGuru.class);
            startActivity(intent);
        });
        findViewById(R.id.m2).setOnClickListener(v -> {
            Intent intent = new Intent(context, com.absensi.sekolah.controller.siswa.HalamanPelajaran.class);
            startActivity(intent);
        });

        findViewById(R.id.m3).setOnClickListener(v -> {
            Intent intent = new Intent(context, com.absensi.sekolah.controller.siswa.HalamanNilai.class);
            startActivity(intent);
        });
        findViewById(R.id.m4).setOnClickListener(v -> {
            Intent intent = new Intent(context, com.absensi.sekolah.controller.siswa.HalamanTugas.class);
            startActivity(intent);
        });
        ...
        findViewById(R.id.m6).setOnClickListener(v -> {
            Intent intent = new Intent(context, com.absensi.sekolah.controller.siswa.HalamanProfile.class);
            startActivity(intent);
        });
        ...
        /**
        bottomSheetLayout.findViewById(R.id.action_hadir).setOnClickListener(v -> {
        ...
        bottomSheetLayout.findViewById(R.id.action_izin).setOnClickListener(v -> {
